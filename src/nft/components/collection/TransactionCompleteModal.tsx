...
import { BackArrowIcon, ChevronUpIcon, LightningBoltIcon, X7Logo } from 'nft/components/icons'
            ...
            {showPurchasedModal && (
              ...
              >
                <Box className={styles.successModal} onClick={stopPropagation}>
                  <X7Logo color={vars.color.accentActive} width="36" height="36" className={styles.uniLogo} />
